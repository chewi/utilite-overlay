...
inherit eutils python-single-r1 multiprocessing autotools flag-o-matic linux-info

CODENAME="Gotham"
EGIT_REPO_URI="https://github.com/xbmc-imx6/xbmc.git"
inherit git-r3
KEYWORDS="~arm"
...
COMMON_DEPEND="${PYTHON_DEPS}
	...
	media-libs/gpu-viv-bin-mx6q
	media-libs/jasper
	media-libs/jbigkit
	>=media-libs/libass-0.9.7
	bluray? ( media-libs/libbluray )
	css? ( media-libs/libdvdcss )
	media-libs/libfslvpuwrap
	media-libs/libmad
...
src_configure() {
	...
	# mxcfb and ipu headers aren't upstreamed yet.
	append-cppflags "-idirafter ${KERNEL_DIR}/include/uapi"
	append-cxxflags "-idirafter ${KERNEL_DIR}/include/uapi"
